...
var url = Xrm.Page.context.getClientUrl() +
        ...
        Xrm.Page.data.entity.getId().replace("{", "").replace("}", "") + "%7d&oType=" +/*Xrm.Page.context.getQueryStringParameters().etc*/ 10162 + 
        "&pagemode=iframe&rof=true&security=852023&tabSet=areaSPDocuments&theme=Outlook15White";
 
    Xrm.Page.getControl("IFRAME_UploadBOM").setSrc(url); //Replace IFRAME_??? with actual IFRAME name
}
...
{
 alert("saved");
var txthtml=$("#IFRAME_UploadBOM").contents().find("body").html();
