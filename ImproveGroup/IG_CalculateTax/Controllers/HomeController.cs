...
namespace IG_CalculateTax.Controllers
{
    public class HomeController : Controller
    {
        ...
        [EnableCors(origins: "https://sandbox-rest.avatax.com", headers: "*", methods: "*")]
        public string Index()
        {
            ...
            .WithSecurity("gordonklein@improvegroup.net", "3550.Impr@ve");
                ...
                var transaction1 = new TransactionBuilder(client, "IMPROVEGROUPINC", DocumentType.SalesOrder, "824859ec-efce-e911-a95e-000d3a110bbd")
                           ...
                           .Create();
                totalTax =Convert.ToString(transaction1.totalTax);
            }
            catch (Exception ex)
            {
